...
```{r tables descriptives 3, echo=FALSE, fig.align="center", out.width="50%", fig.cap="Table 3. Demographic characteristics of the final included sample for modified version"}
knitr::include_graphics("RES/tables_new/demographics_summary.png")
```
