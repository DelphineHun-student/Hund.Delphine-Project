...
This pilot study aims to validate the perceived morphology of dynamic avatars. Participants viewed 12 animated avatars (randomized order) and rated each avatar on 6 adjective-based dimensions: athletic, average, overweight, obese, thin, skinny.
...
<strong> Version 2 (03/02/2026) </strong>

The present analyses are based on Version 2 of the pilot study questionnaire and stimulus set, including the following modifications:

- The adjective *“skinny”* (previously translated as “maigre”) was replaced with a more precise wording referring to *“underweight”* ("sous-poids").
- Updated male avatars using a corrected animation, without shoulder/trapezius deformation (*Catwalk Walk Forward 02*, on Mixamo.com).
...
file_rdata <- file.path(
  project_root, "DAT", "clean", "pre_manip_ratings.rdata")
